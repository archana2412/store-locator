 ...
 * 
 */
class Archana_Storelocator_Helper_Data extends Mage_Core_Helper_Abstract
{
    /**
     ...
     * @var string
     */
    const XML_PATH_ENABLED = 'archana_storelocator_general_setting/archana_storelocator_status/enable';
     ...
     * @var string
     */
    const XML_PATH_DEFAULT_RADIUS = 'archana_storelocator_general_setting/archana_storelocator_display_setting/default_radius';
     ...
     * @var string
     */
    const XML_PATH_DEFAULT_ZOOM_LEVEl = 'archana_storelocator_general_setting/archana_storelocator_display_setting/zoom_level';
     ...
     * @var string
     */
    const XML_PATH_STORES_PER_PAGE = 'archana_storelocator_general_setting/archana_storelocator_display_setting/stores_per_page';
