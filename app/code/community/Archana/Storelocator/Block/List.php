 ...
 * 
 */
class Archana_Storelocator_Block_List extends Mage_Core_Block_Template
{       
    
    /**
     * Stores collection
     *
     * @var Archana_Storelocator_Model_Resource_Storelocator_Collection
     */
     ...
     *
     * @return Archana_Storelocator_Model_Resource_Storelocator_Collection
     */
    ...
    public function getPager()
    {
       $pager = $this->getChild('stores.list.pager');
        if ($pager) {
            $storesPerPage = Mage::helper('archana_storelocator')->getStoresPerPage();
    ...
    {
        return $this->helper('archana_storelocator')->getSearchPostUrl();
    }
     ...
     *
     * @return Mage_Directory_Model_Mysql4_Continent_Collection
     */
    public function getContinent()
    {
        $_continents = Mage::getModel('archana_storelocator/storelocator')->getCollection()
